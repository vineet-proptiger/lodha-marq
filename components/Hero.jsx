      ...
      <div style={{ position: 'absolute', inset: 0, overflow: 'hidden' }}>
        {slides.map((src, idx) => (
          <div key={idx} style={{
            ...
            <Image src={src} alt={`Lodha Marq ${idx + 1}`} fill className="object-cover"
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-end gap-10 w-full">
          ...
          <div className="flex-1 w-full" data-aos="fade-right">
            ...
            <p style={{
              ...
              The Pinnacle of Private Luxury Living
            </p>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '7px', marginBottom: '26px' }}>
              ...
              <span style={{
                ...
                Tardeo, South Mumbai &nbsp;·&nbsp; By Lodha Group
              </span>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px' }}>
                  {[
                    { label: 'Land Parcel', value: '10 Acres' },
