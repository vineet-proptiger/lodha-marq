...
const locationCategories = [
  {
    ...
    items: [
      { name: 'Pedder Road', time: '02 Mins' },
      { name: 'Lower Parel', time: '10 Mins' },
      { name: 'Bandra-Worli Sea Link', time: '15 Mins' },
      { name: 'Chhatrapati Shivaji Maharaj International Airport', time: '25 Mins' },
    ],
  },
  {
    ...
    items: [
      { name: 'The Universal School, Tardeo', time: '02 Mins' },
      { name: 'Aditya Birla World Academy', time: '03 Mins' },
      { name: 'Christ Church School', time: '10 Mins' },
      { name: 'Bombay International School', time: '15 Mins' },
    ],
  },
  {
    title: 'Healthcare',
    ...
    items: [
      { name: 'Apollo Spectra Hospitals', time: '05 Mins' },
      { name: 'Wockhardt Hospital', time: '09 Mins' },
      { name: 'Jaslok Hospital', time: '10 Mins' },
      { name: 'Breach Candy Hospital', time: '12 Mins' },
    ],
  },
  {
    ...
    items: [
      { name: 'Roxy Cinema', time: '05 Mins' },
      { name: 'Willingdon Sports Club', time: '10 Mins' },
      { name: 'Palladium Mall, Lower Parel', time: '15 Mins' },
      { name: 'Marine Drive', time: '20 Mins' },
    ],
  },
]
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3773.224028567345!2d72.8148369!3d18.965711!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7cf1af4a5451f%3A0xf1b59b07aefded!2sLodha%20Marq!5e0!3m2!1sen!2sin!4v1776243828093!5m2!1sen!2sin"
