...
const highlights = [
  {
    text: 'Ultra-Spacious 3, 4 & 5 Bed Luxury Residences',
    icon: <BedDouble {...highlightIconProps} />,
  },
  {
    text: 'Located in the Elite Enclave of Tardeo, South Mumbai',
    icon: <MapPin {...highlightIconProps} />,
  },
  {
    text: 'Lavish Residences with Full-Height French Windows',
    icon: <LayoutPanelLeft {...highlightIconProps} />,
  },
  {
    text: 'Iconic High-Rise with Panoramic Sea & Skyline Views',
    icon: <Building2 {...highlightIconProps} />,
  },
  {
    text: 'Private Decks with Expansive Living Spaces',
    icon: <TrendingUp {...highlightIconProps} />,
  },
  {
    text: 'Limited Residences Ensuring Unmatched Exclusivity',
    icon: <Shield {...highlightIconProps} />,
  },
  {
    text: 'Seamless Connectivity to South Mumbai & BKC',
    icon: <Navigation {...highlightIconProps} />,
  },
  {
    text: 'Crafted with World-Class Specifications & Finishes',
